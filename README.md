...
* **`/core_engine/hia_model.py`**: The definitive $H(z)$ evolution engine.
* **`/validation/mcmc_1M_runs.py`**: Automated statistical validation pipeline.

## 🧪 The HIA Formula
$$H(z) = H_{\Lambda CDM}(z) \times [1 + \alpha e^{-(z/z_{edge})^2}]$$

---
*Terry Kao (PI) & Gemini (AI Research Lead)*
